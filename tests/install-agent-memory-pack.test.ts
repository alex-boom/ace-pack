...
describe('installAcePack', () => {
  it('installs the ACE pack into another repository', async () => {
    ...
    expect(result.createdFiles).toContain('scripts/ace-archive.mjs')
    ...
    expect(result.createdFiles).toContain('scripts/ace-hub-distill.mjs')
    ...
    expect(result.createdFiles).toContain('scripts/ace-task-friction.mjs')
